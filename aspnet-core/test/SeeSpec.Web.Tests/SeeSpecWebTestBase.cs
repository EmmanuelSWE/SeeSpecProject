...
{
    public abstract class SeeSpecWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SeeSpecWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SeeSpecWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<SeeSpecDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<SeeSpecDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SeeSpecDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SeeSpecDbContext, Task<T>> func)
        {
            T result;
